...
public interface ConversationUserTransformer {
	...
	@Mappings({
		...
		@Mapping(source="dto.leftAt", dateFormat="dd/MM/yyyy HH:mm:ss",target="leftAt"),
		@Mapping(source="dto.leftBy", target="leftBy"),
		@Mapping(source="dto.hasDefinitivelyLeft", target="hasDefinitivelyLeft"),
		@Mapping(source="dto.definitivelyLeftAt", dateFormat="dd/MM/yyyy HH:mm:ss",target="definitivelyLeftAt"),
		@Mapping(source="dto.definitivelyLeftBy", target="definitivelyLeftBy"),
		@Mapping(source="dto.recreatedAt", dateFormat="dd/MM/yyyy HH:mm:ss",target="recreatedAt"),
